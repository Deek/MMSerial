...
SS.BlkRd equ   $D0          Block move receive buffer to caller bypassing SCF
...
SS.BlkWr equ   $D1          Block move user buffer to transmit buffer bypassing SCF
...
* If DLAB=0:
Data	equ	0	Data register (RW) (DLAB=0)
